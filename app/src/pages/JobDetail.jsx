          ...
          <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
            ...
            <div className="w-full">
              {user?._id === job?.company?._id ? (
                ...
                <span className="w-full py-3 px-5 bg-green-200 text-base text-green-700">
                  You've already applied this job
                </span>
              ) : (
                <CustomButton
                  title="Apply Now" // When user clicks on "Apply Now" button
